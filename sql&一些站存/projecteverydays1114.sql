...
INSERT INTO `filedata` (`file_ID`, `file_name`, `file_url`, `file_des`, `is_required`, `file_start_d`, `file_end_d`, `file_status`, `is_top`, `file_update_d`) VALUES
(1, '1114', 'templates/tpl_20251114_074343_c86f14.pdf', '', 0, '2025-11-14 18:46:00', '2025-11-22 19:47:00', 1, 0, '2025-11-14 14:43:43');
...
INSERT INTO `milesdata` (`ms_ID`, `req_ID`, `team_ID`, `ms_title`, `ms_desc`, `ms_start_d`, `ms_end_d`, `ms_u_ID`, `ms_completed_d`, `ms_approved_d`, `ms_approved_u_ID`, `ms_status`, `ms_created_d`) VALUES
(1, NULL, 1, 'yoyoyo1114', NULL, '2025-11-11 16:08:00', '2025-11-14 22:13:00', NULL, NULL, NULL, NULL, 1, '2025-11-14 16:08:12');
...
CREATE TABLE `requirementdata` (
  ...
  `edit_u_ID` varchar(25) NOT NULL COMMENT '最後編輯者ID',
...
('109534201', '109534201', '林恩宇', '109534201@stu.ukn.edu.tw', '我站在雲林', 'u_img_109534201_1760580532.jpg', 3, '2025-11-06 11:28:35'),
...
INSERT INTO `workdata` (`work_ID`, `work_title`, `work_content`, `work_u_ID`, `work_status`, `comment`, `work_update_d`) VALUES
(1, 'test1114', '123', 'uknim', 3, NULL, '2025-11-14 14:16:31');
